...
public class StorylinePlacesData {
	...
	/** When the storyline was last updated in ISO 8601 (yyyyMMddTHHmmssZ) format, always in UTC **/
	...
	/** When the summary data was last updated in ISO 8601 (yyyyMMddTHHmmssZ) format, always in UTC **/
